...
@section('content')
  ...
  <div class="movie-info border-b border-gray-800">
    <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
      <img src="{{ $movie['poster_path'] }}" alt="parasite" class="w-62 md:w-96">
      <div class="md:ml-24">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
        @foreach($movie['cast'] as $cast)
          <div class="mt-8">
            ...
            <div class="mt-2">
                <a href="https://movies.andredemos.ca/actors/880" class="text-lg mt-2 hover:text-gray:300">{{ $cast['name'] }}</a>
            </div>
